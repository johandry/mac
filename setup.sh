...
plugins='plugins=(git github gitignore osx python pip sudo golang brew colorize zsh-autosuggestions autoupdate command-not-found common-aliases zsh-safe-rm docker docker-compose emoji emoji-clock themes vagrant aws gcloud npm kubectl helm minikube oc terraform cargo chucknorris zsh-apple-touchbar)'
