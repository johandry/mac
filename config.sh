...
# Cloud Storage
Dropbox=(     cmd 'Dropbox'           "/Applications/Dropbox.app/Contents/MacOS/Dropbox" 'brew cask install dropbox' )
Box_Sync=(    cmd 'Box Sync'          "/Applications/Box Sync.app/Contents/MacOS/Box Sync" 'brew cask install box-sync' )
...
MacDown=(     cmd 'MacDown'           "/Applications/MacDown.app/Contents/MacOS/MacDown" 'brew cask install macdown' )

# Editors
# Sublime3=(    cmd 'Sublime Text 3'    "/Applications/Sublime Text.app/Contents/SharedSupport/bin/subl" 'brew cask install caskroom/versions/sublime-text3' )
Atom=(        cmd 'Atom'              "/Applications/Atom.app/Contents/MacOS/Atom" 'brew cask install atom' )

# Browsers
Firefox=(     cmd 'Firefox'           "/Applications/Firefox.app/Contents/MacOS/firefox" 'brew cask install firefox' )
TorBrowser=(  cmd 'TorBrowser'        "/Applications/TorBrowser.app/Contents/MacOS/firefox" 'brew cask install torbrowser' )

# Movies
HandBrake=(   cmd 'HandBrake'         "/Applications/HandBrake.app/Contents/MacOS/HandBrake" 'brew cask install handbrake' )
HandBrake_CLI=(cmd 'HandBrake CLI'     '/usr/local/bin/HandBrakeCLI' 'brew cask install handbrakecli' )
Subler=(      cmd 'Subler'            "/Applications/Subler.app/Contents/MacOS/Subler" 'brew cask install subler' )
Subler_CLI=(  cmd 'Subler CLI'        '/usr/local/bin/SublerCLI' 'brew cask install sublercli' )
VLC=(         cmd 'VLC'               "/Applications/VLC.app/Contents/MacOS/VLC" 'brew cask install vlc' )
MakeMKV=(     cmd 'MakeMKV'           "/Applications/MakeMKV.app/Contents/MacOS/makemkv" 'brew cask install makemkv' )
MKV_Tools=(   cmd 'MKV Tools'         "/Applications/MKVtools.app/Contents/MacOS/MKVtools" 'brew cask install mkvtools' )

# Music
Spotify=(     cmd 'Spotify'           "/Applications/Spotify.app/Contents/MacOS/Spotify" 'brew cask install spotify' )

# Chat
Colloquy=(    cmd 'Colloquy'          "/Applications/Colloquy.app/Contents/MacOS/Colloquy" 'brew cask install colloquy' )
Skype=(       cmd 'Skype'             "/Applications/Skype.app/Contents/MacOS/Skype" 'brew cask install skype' )

# File Management
Transmission=(cmd 'Transmission'      "/Applications/Transmission.app/Contents/MacOS/Transmission" 'brew cask install transmission' )
UnRarX=(      cmd 'UnRarX'            "/Applications/UnRarX.app/Contents/MacOS/UnRarX" 'brew cask install unrarx' )

# Miscellaneous
Caffeine=(    cmd 'Caffeine'          "/Applications/Caffeine.app/Contents/MacOS/Caffeine" 'brew cask install caffeine' )
Spectacle=(   cmd 'Spectacle'         "/Applications/Spectacle.app/Contents/MacOS/Spectacle" 'brew cask install spectacle' )
