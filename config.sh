...
# Editors
Sublime3=(    cmd 'Sublime Text 3'    "$HOME/Applications/Sublime Text.app/Contents/SharedSupport/bin/subl" 'brew cask install caskroom/versions/sublime-text3' )
Atom=(        cmd 'Atom'              "$HOME/Applications/Atom.app/Contents/MacOS/Atom" 'brew cask install atom' )
